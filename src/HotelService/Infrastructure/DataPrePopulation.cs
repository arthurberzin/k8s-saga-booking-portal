            ...
            if (!context.Set<HotelData>().Any())
            {
                context.Set<HotelData>().AddRange(
                    new HotelData() {
                        ...
                        ReviewScore = 9.6F,
                        MaxPeople = 2,
                        OccupateDates = new List<HotelOccupateDate> { 
                            new HotelOccupateDate(2),
                            new HotelOccupateDate(9),
                            new HotelOccupateDate(12),
                            new HotelOccupateDate(22),
                            new HotelOccupateDate(37),
                            new HotelOccupateDate(47),
                            new HotelOccupateDate(63),
                            new HotelOccupateDate(75),
                            new HotelOccupateDate(78),
                            new HotelOccupateDate(85),
                            new HotelOccupateDate(91),
                            new HotelOccupateDate(98),
                            new HotelOccupateDate(112),
                            new HotelOccupateDate(128),
                            new HotelOccupateDate(132),
                            new HotelOccupateDate(148),
                            new HotelOccupateDate(151),
                            new HotelOccupateDate(159),
                            new HotelOccupateDate(163),
                            new HotelOccupateDate(168),
                            new HotelOccupateDate(170),
                            new HotelOccupateDate(176),
                            new HotelOccupateDate(182),
                            new HotelOccupateDate(184),
                            new HotelOccupateDate(197),
                            new HotelOccupateDate(200),
                            new HotelOccupateDate(201),
                            new HotelOccupateDate(202),
                            new HotelOccupateDate(226),
                            new HotelOccupateDate(233),
                            new HotelOccupateDate(251),
                            new HotelOccupateDate(254),
                            new HotelOccupateDate(267),
                            new HotelOccupateDate(273),
                            new HotelOccupateDate(277),
                            new HotelOccupateDate(284),
                            new HotelOccupateDate(288),
                            new HotelOccupateDate(293),
                            new HotelOccupateDate(295),
                            new HotelOccupateDate(297),
                            new HotelOccupateDate(301),
                            new HotelOccupateDate(308),
                            new HotelOccupateDate(309),
                            new HotelOccupateDate(319),
                            new HotelOccupateDate(327),
                            new HotelOccupateDate(334),
                            new HotelOccupateDate(335),
                            new HotelOccupateDate(340),
                            new HotelOccupateDate(347),
                            new HotelOccupateDate(349)
                        },
